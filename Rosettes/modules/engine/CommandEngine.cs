...
namespace Rosettes.modules.engine
{
    public static class CommandEngine
    {
        ...
        public static void CreateCommandPage()
        {
            ...
            string webContents = $"<p><small>This page is autogenerated by Rosettes every time it restarts. Last update: {DateTime.UtcNow:ddd, dd MMM yyy HH’:’mm’:’ss ‘UTC’}</small></p>\n";
